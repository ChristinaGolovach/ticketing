...
namespace Modules.Events.Data.Migrations
{
    ...
    [Migration("20241015145054_SeedVenues")]
    partial class SeedVenues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Modules.Events.Data.Entities.VenueManifest.Venue", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Lodz",
                            Country = "Poland",
                            Created = new DateTime(2024, 10, 15, 14, 50, 53, 817, DateTimeKind.Utc).AddTicks(7655),
                            Deleted = false,
                            Name = "Arena",
                            Street = "Kolobzesk",
                            Updated = new DateTime(2024, 10, 15, 14, 50, 53, 817, DateTimeKind.Utc).AddTicks(7656)
                        });
                });
